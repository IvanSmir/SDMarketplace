...
public class ProfileController {
    ...
    @GetMapping
    public ResponseEntity<ProfileResult> getAll(Pageable pageable, @RequestParam(required = false) String skill) {
        if(skill != null && !skill.trim().isEmpty()) {
            return new ResponseEntity<>(profileService.getBySkill(skill, pageable), HttpStatus.OK);
        }
